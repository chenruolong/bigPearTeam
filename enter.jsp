...
<form style="margin:10px;">
  ...
  <div class="form-group">
    ...
    <input style="display:inline-block;" onchange="$('#query-emp-id').click();" type="text" class="form-control" id="pro_id" name="pro_id" placeholder="例：D0001S">


    <button id="query-emp-id" style="display:none;" data-href="judge.jsp" class="btn btn-default dq-click">查找</button>
  ...
  <div class="form-group">
    ...
    <input style="display:inline-block;" type="text" class="form-control" id="pro_name" name="pro_name" placeholder="请填写名称">
  </div>
  ...
  <div class="form-group">
    ...
    <input style="display:inline-block;" type="text" class="form-control" id="pro_price" name="pro_price" placeholder="例:12.00">
  </div>

  <div class="form-group">
    <label for="enter_supply">供应商：</label>
    <input style="display:inline-block;" type="text" class="form-control"  placeholder="请填写供应商">
  </div>


  <div style=" margin-bottom:9px;" class="form-group">
    <label for="pro_num">入库数量：</label>
    <input style="display:inline-block;" type="text" class="form-control" id="pro_num" name="pro_num" placeholder="请填写入库数量">
  </div>

  <button style="position:relative; background-color:#fff; border:1px solid rgb(84, 65, 120);"  type="button"  data-href="judge_null.jsp" class="btn dq-click" data-succeed-click="#afterDoUpdSucceed">提交</button>
