...
<form style="margin:10px;">
  ...
  <div class="form-group">
    ...
    <input style="display:inline-block;" type="text" readonly="readonly" class="form-control" id="pro_id" name="pro_id" value="<%=dep.get("pro_id") %>">
  ...
  <div class="form-group">
    ...
    <input style="display:inline-block;" type="text" readonly="readonly"  class="form-control" id="pro_name" name="pro_name" value="<%=dep.get("pro_name") %>">
  </div>

 <div class="form-group">
    <label for="pro_wei">货物重量：</label>
    <input style="display:inline-block;" type="text" readonly="readonly"  class="form-control" id="pro_wei" name="pro_wei" value="<%=dep.get("pro_wei")%>">
  </div>

 <div class="form-group">
    <label for="pro_price">货物价格：</label>
    <input style="display:inline-block; " type="text" readonly="readonly"  class="form-control" id="pro_price" name="pro_price" value="<%=dep.get("pro_price") %>">
  </div>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <label style="display:block;" for="pro_num">入库数量&nbsp;&nbsp;&nbsp;[当前库存<%=dep.get("pro_num") %>]</label>
    <input style="display:inline-block; " type="text" class="form-control" id="pro_num" name="pro_num" placeholder="请填写入库数量" >
  </div>

  <button style="position:relative;background-color:#fff; border:1px solid rgb(84, 65, 120);" type="button"  data-href="enter_refresh1.jsp" class="btn dq-click" data-succeed-click="#afterDoUpdSucceed"  >提交</button>
